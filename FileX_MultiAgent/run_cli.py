...
try:
    from main import run_baseline_discovery  # noqa: E402
except ImportError:
    run_baseline_discovery = None
...
def main() -> int:
    ...
    if args.baseline_only:
        if run_baseline_discovery is None:
            print(json.dumps({"ok": False, "baseline_total_n_kg_ha": None, "pdate": None,
                               "narrative": "", "errors": ["run_baseline_discovery() no longer exists in main.py"]}))
            return 1
        try:
